...
ENV = generate_environment.Environment()
ENV.generate_env(num_qr=num_qr, qr_rotations=qr_rotations, env_filename=filename)
...
retval, A_rvecs, A_tvecs = cv2.solvePnP(objpts, A_imgpts, mtx, dist)
retval, B_rvecs, B_tvecs = cv2.solvePnP(objpts, B_imgpts, mtx, dist)
